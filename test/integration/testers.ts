...
export async function testError(fixture: string, expectedError: string): Promise<void> {
    return expect(run("wrong-options")).to.eventually.rejectedWith("ValidationError");
}
