...
class ProjectDependenciesSuite extends munit.FunSuite {
  test("parse org.scala-lang.modules::scala-async:0.10.0") {
    val dependency =
      getRight(parseDependency("org.scala-lang.modules::scala-async:0.10.0")("2.12", "1"))
  ...
  test("parse org.scalameta:::munit:0.7.2") {
    val dependency = getRight(parseDependency("org.scalameta:::munit:0.7.2")("2.12", "1"))
  ...
  test("stringify org.scalameta:::munit:0.7.2") {
    val dependency =
      getRight(parseDependency("org.scalameta:::munit:0.7.2")("2.12", "1"))
